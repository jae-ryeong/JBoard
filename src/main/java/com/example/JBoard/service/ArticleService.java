...
public class ArticleService {
    ...
    public Long createArticle(ArticleDtoC articleDtoC, UserAccount userAccount) {
        if(!articleDtoC.getTitle().isBlank() || !articleDtoC.getContent().isBlank()){
            try {
                return articleRepository.save(articleDtoC.toEntity(userAccount, null)).getArticleId();  // TODO: 후에 이쁘게 바꿔보자
